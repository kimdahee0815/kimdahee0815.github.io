  ...
  return (
    <>
      <Icon
        size={20}
        strokeWidth={1.5}
        className="absolute -top-4 right-0 z-[-1] h-10 w-10 text-gray-200 dark:text-slate-700 md:-top-2"
      />
      <p className="line-clamp-5 italic text-gray-700 dark:text-slate-400">"{content}"</p>
    </>
  )
}

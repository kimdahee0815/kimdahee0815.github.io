...
export function ProfileCardInfo() {
  ...
  return (
    <div className="hidden py-4 md:block md:px-5">
      <h3 className="text-3xl font-semibold text-gray-800 dark:text-white">{t('profile.name')}</h3>
      <h5 className="py-2 text-xl text-gray-500 dark:text-slate-400">{t('profile.intro')}</h5>

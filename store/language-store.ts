    ...
    (set) => ({
      ...
      translations: {
        ko: {
          ...
          home: {
            intro1:
              '<p>아프리카 4개국을 트럭킹으로 24일간 여행하며, 여러 나라에서 온 친구들과 매일 함께 텐트를 치고 생활했습니다.</p><p>그중 한 친구는 <b className="font-medium">컴퓨터공학을 전공한 개발자</b>였고, 어디서든 일하며 여행을 이어갈 수 있다는 이야기를 들려주었습니다. 그때 처음으로 \'이런 삶도 가능하구나\'라는 생각을 했고, 그 경험은 지금 제가 이 방식으로 일하고 싶은 중요한 계기가 되었습니다.</p>',
            intro2:

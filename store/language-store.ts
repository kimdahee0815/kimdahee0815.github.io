      ...
      translations: {
        ...
        en: {
          ...
          home: {
            ...
            typedbios:
              '<li>I wrote my first lines of code in <b className="font-medium">C</b>. 💻</li><li>During my Africa trip, I even went skydiving. 🪂</li><li>I recharge through <b className="font-medium">swimming, dancing, and traveling</b>. 💃🏻</li><li>I\'m a cat lover with the unfortunate bonus of cat allergies. 😿</li><li>I\'ve been a regular member of a <b className="font-medium">book club</b> for years! 📚</li>',
